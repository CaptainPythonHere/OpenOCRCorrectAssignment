...
void MainWindow::on_actionUn_Italics_triggered()
{
    QTextCharFormat format;
...
void MainWindow::on_actionUn_Underline_triggered()
{
    QTextCharFormat format;
...
{
    QMessageBox message;
    message.information(this, "About", "Know more here: https://youtu.be/0hcdlF-zn8E");
}
